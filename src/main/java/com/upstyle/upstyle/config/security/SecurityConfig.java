...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/users/**", "/auth/**", "/ootds/**", "/clothes/**", "/closet/**",  "/calendar/**", "/login/oauth2/code/google", "/login", "/signin/**", "/more_info","/bookmarks/**") // CSRF 비활성화 경로
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/users/**", "/auth/**", "/ootds/**", "/clothes/**", "/closet/**", "/calendar/**", "/login/oauth2/code/google", "/login", "/more_info","/bookmarks/").permitAll()
